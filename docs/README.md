...
# EnvForge Design Documentation v1.1
...
- **v1.1**：根据全量审计修复后的 Accepted Design Baseline。 修复记录见 [`00-governance/v1.1-audit-remediation.md`](00-governance/v1.1-audit-remediation.md)。
- 所有已确认不变量的变更必须通过 ADR。
...
旧产品、UI、Capability、运维和历史 Phase 文档已按 [`00-governance/legacy-document-migration.md`](00-governance/legacy-document-migration.md) 迁移。目标体验见 [`15-experience`](15-experience/README.md)；当前旧实现指南为 informative，不属于目标架构事实源。

...
test("legacy mutation route handlers fail closed in their own bodies", async () => {
  ...
  for (const handler of handlers) {
    ...
    for (const forbidden of ["executePlaybookTask", "executePlaybook", "writeConfigFile", "restoreConfigFileFromBackup", "runMigrationApplyPlan", "executeBatchCatalogTask", "buildSnapshotDeployTask", "executeCatalogTask"]) {
